...
var sh = {
	...
	config : {
		...
		clipboardSwf : '/javascripts/clipboard.swf',
		...
		strings : {
			expandSource : 'Pokaži izvorno kodo',
			viewSource : 'Pokaži neobarvano kodo',
			copyToClipboard : 'Kopiraj v odložišče',
			copyToClipboardConfirmation : 'Koda je v odložišču.',
			print : 'Natisni',
			help : '?',
			alert: '',
