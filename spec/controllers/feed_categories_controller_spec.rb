...
describe FeedCategoriesController do
  fixtures :all
  integrate_views
  ...
  it "create action should redirect when model is valid" do
    ...
    post :create
    response.should redirect_to(feed_category_url(assigns[:feed_category]))
  end
  ...
  it "destroy action should destroy model and redirect to index action" do
    ...
    response.should redirect_to(feed_categories_url)
